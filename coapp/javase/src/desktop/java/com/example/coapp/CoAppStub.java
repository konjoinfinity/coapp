 ...
 * @author Shai Almog
 */
public class CoAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "CoApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new CoAppStub());
    }
